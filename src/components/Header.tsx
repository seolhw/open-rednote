...
export default function Header() {
	return (
		<header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/90 px-4 backdrop-blur">
			<nav className="mx-auto flex w-full max-w-[1160px] flex-wrap items-center gap-x-3 gap-y-2 py-3 sm:py-4">
				<h2 className="m-0 flex-shrink-0 text-base font-semibold tracking-tight">
					<Link
						to="/"
						className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3 py-1.5 text-sm text-zinc-900 no-underline shadow-sm sm:px-4 sm:py-2"
					>
				...
				<div className="order-3 flex w-full flex-wrap items-center gap-x-4 gap-y-1 pb-1 text-sm font-semibold sm:order-2 sm:w-auto sm:flex-nowrap sm:pb-0">
					<Link
						to="/"
						className="text-sm font-semibold text-zinc-500 no-underline transition hover:text-zinc-900"
						activeProps={{
							className:
								"text-sm font-semibold text-zinc-900 underline decoration-rose-500 decoration-2 underline-offset-8",
						}}
					>
						工作台
					</Link>
