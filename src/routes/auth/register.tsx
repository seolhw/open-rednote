...
function RegisterPage() {
	...
	const onSubmit = async ({
		...
		if (result.error) {
			setErrorMessage(result.error.message || "注册失败");
			return;
		}
	...
	return (
		<div className="mx-auto w-full max-w-md px-4 py-10">
			<div className="rounded-lg border p-6">
				...
				<p className="mt-2 text-sm text-neutral-500">创建新账号</p>
				...
				>
					...
					<div>
						<label htmlFor="email" className="mb-1 block text-sm">邮箱</label>
						<input
							type="email"
							value={email}
					...
					<div>
						<label htmlFor="password" className="mb-1 block text-sm">密码</label>
						<input
							type="password"
							value={password}
