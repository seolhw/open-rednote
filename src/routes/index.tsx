			...
			<Card>
				...
				<CardContent className="flex flex-wrap gap-3">
					<Button asChild variant="outline">
						<Link to="/chat">打开 AI 助手</Link>
					</Button>
					<Button asChild variant="secondary">
						<Link to="/blog">阅读 Blog</Link>
					</Button>
					<Button asChild variant="secondary">
			...
			<Card>
				...
				<CardContent className="grid gap-3">
					{[
						...
						<div
							key={title}
							className="grid grid-cols-[2rem_1fr] gap-3 rounded-xl border p-3"
						>
							<Badge className="h-8 w-8 justify-center rounded-full p-0">
								{idx + 1}
							</Badge>
							<div>
